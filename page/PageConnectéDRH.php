...
<body class='fontConnecté'>
  ...
  <?php if (isset($_SESSION["identifiant"])) { ?>
    <a class="Nom_identifiant">Monsard Camille
      <?php
  ...
  <a class="cloche"><img href="Liste des CP et RTT.php" onclick="window.open('Liste des CP et RTT.php', 'popup', 'width=800,height=600'); return false;" src="../style/img/cloche.png" alt="Cloche" />Liste des CP/RTT en attente</a>
